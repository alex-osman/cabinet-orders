            ...
            <div key={index} className="cabinet-section col-12">
              ...
              <div className="row">
                <div className="cabinet-width col-md-4">
                  ...
                  <input
                    ...
                    value={cabinet.width}
                    onChange={(e) =>
                      updateCabinet(index, "width", parseFloat(e.target.value))
                    }
                    min={15}
                    max={30.75}
                    step={0.25}
                ...
                <div className="col-md-4">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      updateCabinet(index, "height", parseFloat(e.target.value))
                    }
                    min={15}
                    max={30.75}
                    step={0.25}
              ...
              <div className="row">
                <div className="col-md-4">
                  ...
                  <select
                    ...
                    value={cabinet.style}
                    onChange={(e) =>
                      updateCabinet(index, "style", e.target.value as StyleType)
                    }
                    required
                  >
              ...
              {cabinet.configurationType && (
                <div className="text-center mb-3">
                  ...
                  />
                  <p>
                    <strong>Style:</strong> {cabinet.style}
                  </p>
                </div>
              )}
            </div>
